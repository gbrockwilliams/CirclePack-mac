...
* If Jigloo is being used commercially 
* (ie, by a corporation, company or business 
* for any purpose whatever) then you should 
* purchase a license for each developer using 
* Jigloo. Please visit www.cloudgarden.com 
* for details.
* Use of Jigloo implies acceptance of these 
* licensing terms.
