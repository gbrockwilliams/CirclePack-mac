 ...
 * menu events, into CPcanvas, but leaving buffered image here for 
 * use with either GUI version or standalone version. Things marked 
 * "GUI" will eventually be moved elsewhere.
 * 
 * In 'CirclePack', we have 'PackData' for a circle packing associated
 * with this CPdrawing (in fact, packData is created in this constructor).
 * There are many things that could logically go either in PackData or 
 * CPcanvas; in general, try to put things here if they might be used in 
 ...
 * 
 * CirclePack will have 'NUM_PACKS' (currently 3) CPdrawing's, each 
...
public class CPdrawing extends JPanel implements MouseListener {
	...
	public CPdrawing(int screennum) {
...
//		super.paintComponent(g);
	...
	public void updateXtenders() {
		...
		int pnum=getPackNum();
		panels.SmallCanvasPanel scp=PackControl.smallCanvasPanel;
